...
<html>
    <head>
        ...
        <script src="AdminJS/AddUserPageJS.js"></script>
    ...
    <section class="page-content">
        ...
        <%-- -------------------------------------------------------------------------------------------------------------------------------------------- --%>
        <!--==================add User=========================-->
        <a class="close" href="UserController?action=get">&times;</a>
        <div class="info">
            <form action="UserController" method="POST"> 
                <div class="content">
                    ...
                    <div>
                        ...
                        <input name="surName" type="text" class="input-field"required>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input name="telephone" type="number" min="0" id="numberInput" oninput="enforceLength(this)" maxlength="10" class="input-field" required="">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input name="street" type="text" class="input-field"required>
                    </div>
                    <div>
                        <label>Suburb</label><br>
                        <input name="suburb" type="text" class="input-field"required>
                    </div>
                    <div>
                        <label>Code</label><br>
                        <input name="code" type="text" class="input-field"required>
                    </div>
                    <div class="but">
                        <input name="role" value="PUBLIC" type="hidden" >
                        <input name="action" value="add" type="hidden" >
                        <input value="Submit" type="Submit" class="buttonTable">
                    </div>
                </div></form>
        </div>
